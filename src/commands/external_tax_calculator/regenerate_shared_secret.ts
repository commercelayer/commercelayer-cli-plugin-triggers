...
export default class ExternalTaxCalculatorRegenerateSharedSecret extends Command {
  ...
  static flags = {
    ...
    const { args, flags } = await this.parse(ExternalTaxCalculatorRegenerateSharedSecret)
